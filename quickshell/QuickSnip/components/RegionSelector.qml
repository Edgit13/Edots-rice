...
Item {
    ...
    property color overlayTint: Qt.rgba(0.15, 0.15, 0.18, 0.3)
    property color labelBgColor: Qt.rgba(0.12, 0.12, 0.14, 0.9)
    property color labelTextColor: Qt.rgba(0.9, 0.9, 0.9, 1)
    property color guideColor: Qt.rgba(1, 1, 1, 0.8)
    property color guideShadowColor: Qt.rgba(0, 0, 0, 0.4)
