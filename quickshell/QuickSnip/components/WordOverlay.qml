...
FocusScope {
    ...
    // Edots colors — passed in from shell.qml (Theme). Defaults preserve
    // the original upstream look if left unbound.
    property color accentColor: "#cba6f7"
    property color surfaceColor: Qt.rgba(0.1, 0.1, 0.12, 0.95)
    property color surfaceBorderColor: Qt.rgba(1, 1, 1, 0.2)
    property color textColor: "white"
    property color textDimColor: Qt.rgba(1, 1, 1, 0.6)
    property color hintBgColor: Qt.rgba(0.06, 0.06, 0.08, 0.94)
    property color wordIdleColor: Qt.rgba(0.5, 0.5, 0.5, 0.35)
    property color lensButtonColor: Qt.rgba(0.12, 0.12, 0.14, 0.9)
    property color statusBorderColor: Qt.rgba(0.7, 0.63, 0.55, 0.15)
    ...
    component ToolbarButton: Rectangle {
        ...
        property color iconColor: Qt.rgba(root.textColor.r, root.textColor.g, root.textColor.b, 0.95)
        ...
        color: btnMouse.pressed
            ...
            : btnMouse.containsMouse ? Qt.rgba(root.textColor.r, root.textColor.g, root.textColor.b, 0.08) : "transparent"
        ...
        Row {
            ...
            Text {
                text: btn.label; color: root.textColor
        ...
        Rectangle {
            ...
            height: 24; radius: 8
            color: root.hintBgColor
            border.color: Qt.rgba(root.textColor.r, root.textColor.g, root.textColor.b, 0.1); border.width: 1
    ...
    Rectangle {
        ...
        border.color: root.surfaceBorderColor; border.width: 1
        ...
        Row {
            ...
            ToolbarSeparator {}
            ToolbarButton { icon: "󰒆"; label: "All"; shortcutHint: "Ctrl+A"; iconColor: Qt.rgba(root.textColor.r, root.textColor.g, root.textColor.b, 0.5); onClicked: root.selectAllRequested() }
        }
    }
    ...
    component StatusPill: Rectangle {
        ...
        color: "transparent"
        border.color: root.statusBorderColor; border.width: 1
        z: 100
        ...
        Row {
            ...
            Rectangle {
                ...
                width: 14; height: 14; radius: 7
                color: "transparent"
                border.color: Qt.rgba(root.textColor.r, root.textColor.g, root.textColor.b, 0.7); border.width: 2
                anchors.verticalCenter: parent.verticalCenter
            ...
            Text {
                id: pillText
                color: showSpinner ? root.textColor : root.textDimColor
                font.pixelSize: 13
                anchors.verticalCenter: parent.verticalCenter
            }
        }
